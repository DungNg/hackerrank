const script = require("../pickingNumbers.js");

it("should return 5", () => {
  expect(script.pickingNumbers([1, 2, 2, 3, 1, 2])).toBe(5);
});
...
it("should return 15", () => {
  ...
  expect(script.pickingNumbers(input.split(" "))).toBe(15);
});
...
it("should return 100", () => {
    ...
    expect(script.pickingNumbers(input.split(" "))).toBe(100);
  });
